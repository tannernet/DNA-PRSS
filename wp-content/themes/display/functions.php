...
##################################################################
$the_theme = get_theme_data(TEMPLATEPATH . '/style.css.min');
...
$autoload['helper'] = array('breadcrumb', 				# breadcrumb navigation
							...
							'twitter',
							'nav_menu',					# get twitter feed and display it
							'kriesi_build_image'		# display a resized image
							);

$autoload['classes'] = array('kclass_display_box','description_walker');		# display of small content boxes that can display post/page or widget content
