...
if (isset($k_option['custom']['bodyclass']) && !empty($k_option['custom']['bodyclass'])) $k_body_class = 'fullwidth';
?>

<body id='<?php echo $k_page_id; ?>' <?php body_class($k_body_class);?>>
	...
	<div class='wrapper'>
		...
		<div id="top">
			...
			<div id="head">
				...
				<h6 id="tagline">Digital News Aggregation</h6>
				<?php 
	...
	'depth' => 0, 'context' => 'frontend',  'walker' => new description_walker() ));
				...
				function displayfallbackSlider(){
				global $k_option;
