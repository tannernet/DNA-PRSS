...
if(isset($_POST['Send'])){
		...
		$the_name = urldecode( $_POST['yourname'] );
		$the_email = urldecode( $_POST['email'] );
		$the_website = urldecode( $_POST['website'] );
		$the_message = urldecode( $_POST['message'] );
		...
		{	
            ...
            $subject = "New Message from " . urldecode($_POST['myblogname']);
